...
class GameSim():
    def __init__(self, first_player, dimension, displayer):
    ...
    def set(self, reset_data):
        reset_data = copy.deepcopy(reset_data)
    ...
    def record(self):
        ...
        return copy.deepcopy((self.current_player, self.groups, self.board_history, self.input_history, self.just_passed, self.winner, self.moves_played, self.boardstate))
